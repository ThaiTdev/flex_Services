import Form from "./components/FormResto";
import Header from "../../../components/Header";
import Footer from "../../../components/Footer";
import styles from "./FormUpdateRestaurant.module.scss";
  ...
  return (
    ...
    >
      ...
      <main className={`${styles.profilContainer} `}>
        ...
        >
          <Link
            to={`/ShowOneRestaurant/${id}/${idResto}`}
            style={{ textDecoration: "none" }}
          >
            <i className={`fa-solid fa-arrow-left fz-20  `}></i>
          </Link>
          <p className="fz-20 ml-10 ">Je peux modifier mon restaurant</p>
        </div>
...
export default FormUpdateRestaurant;
